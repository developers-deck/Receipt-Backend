...
let ReceiptsService = class ReceiptsService {
    ...
    async getReceipt(verificationCode, receiptTime, userId) {
        ...
        try {
            ...
            const updatedResult = await this.db.update(schema_1.receipts)
                .set({ pdfUrl })
                .where((0, drizzle_orm_1.eq)(schema_1.receipts.id, insertedReceipt.id))
                .returning();
    ...
    async generateReceiptPdf(receiptData) {
        const traLogoUrl = 'https://your-tra-logo-url.com/logo.png';
      ...
      <head>
          ...
          <style>
              body { font-family: 'Gentelella', 'Nunito Sans', Arial, Helvetica, sans-serif; background: #fafbfc; color: #222; }
